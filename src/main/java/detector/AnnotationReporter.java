...
public class AnnotationReporter {
	...
	/**
	 * store row count of ticket which are matched used in Excel sheet
	 */
	static int matchticketRowCount = 1;
	/**
	 * store row count of ticket which are unmatched used in Excel sheet
	 */
	...
	public static void createExcel() {
		...
		try {
			...
			/**
			 * code for autoSizeColumn for unmatched tickets sheet
			 */
			for (int columnPosition = 0; columnPosition < 5; columnPosition++) {
	 ...
	 */
	public static void matchedTickets(JiraRestClient jc) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			final JiraRestClient jc = f.createWithBasicHttpAuthentication(
